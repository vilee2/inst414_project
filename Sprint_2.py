...
cols_to_keep = ['Data_Value', 'Race/Ethnicity', 'Age(months)', 'Sex', 'LocationDesc']
...
df_race = df_drop_na[df_drop_na['Race/Ethnicity'].isin(['American Indian/Alaska Native', 'Non-Hispanic White'])]
df_race.shape
